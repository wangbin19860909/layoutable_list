...
class StackSnapScrollPhysics extends BouncingScrollPhysics {
  final ServiceHolder<LayoutManager> layoutService;

  const StackSnapScrollPhysics({required this.layoutService, super.parent});
  ...
  double _getTargetOffset(
    ...
    final double itemExtent = layoutService.target!.itemExtent;
    ...
    if (velocity.abs() < tolerance.velocity) {
      ...
      // 计算目标 index
      targetIndex = (currentIndex + cardOffset).clamp(0, layoutService.target!.itemCount - 1);
